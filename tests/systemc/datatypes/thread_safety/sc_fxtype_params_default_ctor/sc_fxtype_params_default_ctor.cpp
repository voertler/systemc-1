...
{
    std::cout << "test sc_fxtype_params_default_ctor started" << std::endl;
    ...
    for (int i = 0; i < NUMTHREADS; ++i)
        my_thread[i].join();
    std::cout << "test sc_fxtype_params_default_ctor finished" << std::endl;
    return 0;
}
